...
def fetch_unemployment():
    ...
    parsed_response = unemployment_response.json()
...
if __name__ == "__main__":
    ...
    print("Unemployment rates in the US over the last 10 months: ")
    for i in range(10):
    ...
    print(" ")
    print("Average unemployment rates in the US over the last 5 years: ")
    ...
    fig = line(x=x_axis, y=y_axis, title="United States Unemployment Rate over Time", labels= {"x": "Time", "y": "Unemployment Rate"}, markers=True)
    fig.show()
