# this is the app/interest.py file...
...
def fetch_interest():
    interest_url = f"https://www.alphavantage.co/query?function=FEDERAL_FUNDS_RATE&interval=monthly&apikey={API_KEY}"
    interest_response = requests.get(interest_url)
    parsed_response = interest_response.json()
...
if __name__ == "__main__":
    ...
    print("Interest rates in the US over the last 10 months: ")
    for i in range(10):
    ...
    print(" ")
    print("Average interest rates in the US over the last 5 years: ")
    ...
    fig = line(x=x_axis, y=y_axis, title="United States Interest Rate over Time", labels= {"x": "Time", "y": "Interest Rate"}, markers=True)
    fig.show()
